    ...
    <main className="min-h-[85vh] bg-[radial-gradient(120%_85%_at_50%_-15%,rgba(56,189,248,0.14),transparent_55%),linear-gradient(180deg,#020617,#0f172a)] px-4 py-12 text-slate-100">
      <div className="mx-auto max-w-5xl space-y-8">
        <header className="space-y-2">
          <p className="text-xs font-semibold uppercase tracking-[0.2em] text-sky-300/90">SEO</p>
          <h1 className="text-2xl font-semibold text-white md:text-3xl">Artikel SEO (refrigerasi industri)</h1>
          <p className="text-sm text-slate-400">
            Konten disimpan di <code className="text-sky-200/90">data/seo-articles/live.json</code>. Halaman publik:{" "}
            <Link href="/artikel" className="text-sky-300 underline-offset-4 hover:underline">
              /artikel
            </Link>
            .
          </p>
