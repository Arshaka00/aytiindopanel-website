...
export const metadata: Metadata = {
  title: "Editor artikel /artikel | Panel CMS",
    ...
    <main className="min-h-[85vh] bg-[radial-gradient(120%_85%_at_50%_-15%,rgba(56,189,248,0.14),transparent_55%),linear-gradient(180deg,#020617,#0f172a)] px-4 py-12 text-slate-100">
      <div className="mx-auto max-w-5xl space-y-8">
        <header className="space-y-3">
          <p className="text-xs font-semibold uppercase tracking-[0.2em] text-emerald-300/90">Artikel /artikel</p>
          <h1 className="text-2xl font-semibold text-white md:text-3xl">Editor artikel /artikel</h1>
