...
export default async function MaintenancePage() {
  ...
  return (
    <main className="relative isolate flex min-h-[100dvh] items-start justify-center overflow-hidden bg-slate-100 px-4 pb-14 pt-[max(0.5rem,env(safe-area-inset-top,0px))] text-slate-900 sm:pt-6 md:pt-20 dark:bg-black dark:text-slate-100">
      ...
      <section className="relative mt-0 w-full max-w-2xl rounded-3xl border border-slate-300/80 bg-white/88 p-5 shadow-[0_24px_80px_rgba(15,23,42,0.18)] backdrop-blur-xl sm:p-8 md:mt-2 md:p-10 dark:border-white/20 dark:bg-black/80 dark:shadow-[0_30px_120px_rgba(0,0,0,0.95)] motion-safe:animate-[premium-page-reveal_420ms_var(--ease-premium-soft)_both]">
