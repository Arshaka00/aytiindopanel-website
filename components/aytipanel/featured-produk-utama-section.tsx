...
const HERO_BULLETS = [
  "Ketebalan 50–150 mm",
  "Sistem camlock / modular",
  "Minim thermal leakage",
  ...
  return (
    <>
      <ul
        ...
        role="list"
        aria-label="Fitur utama sandwich panel"
      >
...
const SCROLL_SECTION_ID = "produk-utama" satisfies FeaturedProdukScrollSectionId;
              ...
              <div className={featuredDualImageHalfFrame}>
                <div className={featuredDualImageViewportHeights}>
                  <CmsImage
                    ...
                    srcPath="produk.featuredImages.utama.leftSrc"
                    alt={featuredImages.leftAlt}
                    uploadScope="produk"
                    uploadSegment="featured-utama-left"
                    ...
                    transformPatchPath="produk.featuredImages.utama.leftAdjust"
                  />
                </div>
              </div>
              <div className={featuredDualImageHalfFrame}>
                <div className={featuredDualImageViewportHeights}>
                  <CmsImage
                    ...
                    srcPath="produk.featuredImages.utama.rightSrc"
                    alt={featuredImages.rightAlt}
                    uploadScope="produk"
                    uploadSegment="featured-utama-right"
                    sizes="(max-width: 1024px) 48vw, 24vw"
                    className="relative block h-full w-full min-h-0"
                    imageClassName="object-cover"
                    imageTransform={featuredImages.rightAdjust}
                    transformPatchPath="produk.featuredImages.utama.rightAdjust"
                  />
                </div>
              </div>
            </div>
