...
const HERO_BULLETS = [
  "Pintu insulated kedap suhu",
  "Sistem dock meminimalkan kehilangan temperatur",
  "Unit refrigerasi & kontrol terintegrasi",
...
function ProdukAccessoriesBulletsNav({
  productLinks,
}: {
  ...
  return (
    <>
      <ul
        ...
        role="list"
        aria-label="Komponen pendukung cold room"
      >
...
function ProdukAccessoriesDetailBlocks({
  category,
  categoryIndex,
  productLinks,
}: {
  ...
  return (
    <>
      <ProdukAccessoriesLead category={category} categoryIndex={categoryIndex} />
      <ProdukAccessoriesBulletsNav productLinks={productLinks} />
    </>
  );
}

const SCROLL_SECTION_ID = "accessories" satisfies FeaturedProdukScrollSectionId;
              ...
              <div className={featuredDualImageHalfFrame}>
                <div className={featuredDualImageViewportHeights}>
                  <CmsImage
                    ...
                    srcPath="produk.featuredImages.accessories.leftSrc"
                    alt={featuredImages.leftAlt}
                    uploadScope="produk"
                    uploadSegment="featured-accessories-left"
                    ...
                    transformPatchPath="produk.featuredImages.accessories.leftAdjust"
                  />
                </div>
              </div>
              <div className={featuredDualImageHalfFrame}>
                <div className={featuredDualImageViewportHeights}>
                  <CmsImage
                    ...
                    srcPath="produk.featuredImages.accessories.rightSrc"
                    alt={featuredImages.rightAlt}
                    uploadScope="produk"
                    uploadSegment="featured-accessories-right"
                    sizes="(max-width: 1024px) 48vw, 24vw"
                    className="relative block h-full w-full min-h-0"
                    imageClassName="object-cover"
                    imageTransform={featuredImages.rightAdjust}
                    transformPatchPath="produk.featuredImages.accessories.rightAdjust"
                  />
                </div>
              </div>
            </div>
          ...
          {mobile.scrollMode ? (
            <div className="order-4 min-w-0 md:hidden">
              <FeaturedProdukMobileScrollPanel
                ...
                panelId="featured-produk-accessories-details"
