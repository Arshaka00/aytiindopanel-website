...
import { buildGalleryProjectBackFallbackHref } from "@/lib/product-listing-sections";
...
/** Offset di bawah header, sejajar tombol kembali detail produk. */
...
type GalleryProjectBackNavProps = {
  className?: string;
};

/**
 * Tombol kembali gallery — `/#proyek` (CTA Portfolio) atau `/#beranda` (navbar), dari sessionStorage.
 */
export function GalleryProjectBackNav({ className = "" }: GalleryProjectBackNavProps) {
  return (
    <BackButton
      label="Kembali"
      destination="previous"
      fallbackHref={buildGalleryProjectBackFallbackHref()}
 ...
 */
export function GalleryProjectBackNavPinned() {
  return (
    <>
      <div
