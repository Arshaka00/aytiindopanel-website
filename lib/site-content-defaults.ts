...
Terima kasih.`,
    ...
    header: {
      ...
      siteSearchPlaceholder: "Masukkan kata kunci",
...
Terima kasih.`,
    ...
    tentang: {
      ...
      body:
        "Didukung pengalaman tim lebih dari 5 tahun dan pabrik panel milik sendiri, kami siap mendukung kebutuhan proyek Anda mulai dari konsultasi, desain, produksi sandwich panel, produksi pintu panel dan sistem docking, instalasi sandwich panel, dan instalasi sistem refrigerasi, hingga dukungan purna jual dan after sales secara menyeluruh dan terintegrasi.",
      ...
      projects: [
        {
          ...
          technicalSpecs: [
            { label: "Temperatur", value: "Chiller +2°C s/d +8°C · Freezer −18°C s/d −25°C" },
            { label: "Kapasitas penyimpanan", value: "500 ton" },
            { label: "Sistem pendingin", value: "±85 TR (sistem refrigerasi terpadu)" },
            { label: "Insulasi Ruangan", value: "Sandwich panel PU 100 mm · sistem camlock" },
          ],
        ...
        },
        {
          ...
          technicalSpecs: [
            { label: "Temperatur", value: "ABF −35°C · Cold storage −22°C · Blast −40°C" },
            { label: "Kapasitas penyimpanan", value: "600 ton" },
            { label: "Sistem pendingin", value: "±150 TR · multi-kompresor" },
            { label: "Insulasi Ruangan", value: "PU/EPS 80–120 mm · pintu cold room industri" },
          ],
          videoSrc: "/images/gallery/WhatsApp%20Video%202026-05-07%20at%2011.02.55.mp4",
          videoAutoplay: false,
          galleryPhotos: [
        ...
        },
        {
          ...
          technicalSpecs: [
            { label: "Temperatur", value: "Chiller 0°C s/d +4°C · Freezer −20°C" },
            { label: "Kapasitas penyimpanan", value: "850 ton" },
            { label: "Sistem pendingin", value: "±95 TR · redundansi unit pendingin" },
            { label: "Insulasi Ruangan", value: "PU 100 mm · floor insulated" },
          ],
          videoSrc: "/images/gallery/WhatsApp%20Video%202026-05-07%20at%2011.02.55.mp4",
          videoAutoplay: false,
          galleryPhotos: [
        ...
        },
        {
          ...
          technicalSpecs: [
            { label: "Temperatur", value: "Proses +2°C s/d +6°C · Cold storage −18°C" },
            { label: "Kapasitas penyimpanan", value: "200 ton" },
            { label: "Sistem pendingin", value: "±65 TR" },
            { label: "Insulasi Ruangan", value: "PU 80 mm food-grade · sambungan higienis" },
          ],
          videoSrc: "/images/gallery/WhatsApp%20Video%202026-05-07%20at%2011.02.55.mp4",
          videoAutoplay: false,
          galleryPhotos: [
